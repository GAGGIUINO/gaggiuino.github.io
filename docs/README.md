...
>*Powering using the [ 12v ] power supply module + [ 5v ] stepdown convertor is the recommended way, follow the bellow scheme:*
...
_Powering all the arduino connected boards through the USB port is not recommended due to the low power capacity of the on-board voltage regulator, this will kill your arduino eventually you've been warned!_
