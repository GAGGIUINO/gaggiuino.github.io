...
The Time of Flight and LED (ToFnLED) board provides a sensor for determining tank water level and LED for tank lighting. 
...
* 3D-Printed Housing, available on [Printables](https://www.printables.com/model/502813) or can be ordered from official print providers
    * [2 disc magnets, 5 mm dia. x 1 mm ht. (for magnetic espresso machine)](https://www.aliexpress.com/item/3256801641477250.html). The 2 mm ht. magnets used by the [hardware scales](accessories/hw-scales.md) also work but decrease the sense region by 1 mm.
