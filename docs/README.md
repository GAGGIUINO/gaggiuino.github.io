...
> [!Note] 
> If you're not experienced with ordering PCBs it can be group ordered through Discord where the ordering process can be monitored and possible frauds averted.
>
